<template>
    <div class="px-4 pt-20 lg:pt-6 grid-cols-3">
        <!-- Main widget -->
        <div
            class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
        ...
        <div
            class="p-4 col-span-1 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
