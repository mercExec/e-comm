    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0">
        <div
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="#" @submit.prevent="handleRegistration(form)">
                    <div>
                    ...
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                        Already have an account? <a href="#"
                            class="font-medium text-blue-600 hover:underline dark:text-blue-500">Sign here</a>
                    </p>
                </form>
            </div>
        </div>
...
const handleRegistration = async (form) => {
    try {
        await auth.handleRegistration(form)
            .then(async () => {
